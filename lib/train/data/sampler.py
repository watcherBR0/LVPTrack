...
class TrackingSampler(torch.utils.data.Dataset):
    ...
    def __init__(self, datasets, p_datasets, samples_per_epoch, max_gap,
        ...
        if extreme_type == 'haze':
            ...
            self.pl_path = os.path.join(pl_path, 'pseudo_label/got10k_train_rainy') if pl_path != '' else ''
        else:
            self.pl_path = ''
    ...
    def getitem(self):
        ...
        while not valid:
            ...
            try:
                ...
                #0712
                # if dataset.name == 'GOT10k' or dataset.name == 'GOT10k_haze':
                if dataset.name == 'GOT10k_haze' or dataset.name == 'GOT10k_dark' or  dataset.name == 'GOT10k_rainy':
                    template_frames, template_anno, meta_obj_train, _ = dataset.get_frames(seq_id, template_frame_ids, seq_info_dict)
                ...
                data = TensorDict({'template_images': template_frames,
                                   ...
                                   #0708
                                   'search_images_path': search_frame_paths,
                ...
                # print("7:{}".format(time.time()))
                # check whether data is valid
                valid = data['valid']
                # print(i)
                # print("final:{}".format(time.time()))
    ...
    def sample_seq_from_dataset(self, dataset, is_video_dataset):
        ...
        while not enough_visible_frames:
            ...
            # Sample frames
            if dataset.name == 'GOT10k_haze' or dataset.name == 'GOT10k' or dataset.name == 'GOT10k_dark' or dataset.name == 'GOT10k_rainy':
