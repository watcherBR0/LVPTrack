...
class LTRTrainer(BaseTrainer):
    ...
    def cycle_dataset(self, loader):
        ...
        for i, data in enumerate(loader, 1):
            ...
            if loader_type == 'train_extreme':
                ...
                if i == 1:
                    ...
                    pl_box_dict['img_paths'] = data['search_images_path'][0]
                    ...
                    pl_box_dict['img_paths'] = pl_box_dict['img_paths'] + data['search_images_path'][0]

                    pl_box_dict['search_box_extract'] = torch.cat((pl_box_dict['search_box_extract'], data['search_box_extract']), dim=0)
                    pl_box_dict['search_resize_factors'] = torch.cat((pl_box_dict['search_resize_factors'], data['search_resize_factors']), dim=0)
                    pl_box_dict['search_original_shape'] = torch.cat((pl_box_dict['search_original_shape'], data['search_original_shape']), dim=0)
        ...
        if loader.name == 'train_extreme':
            ...
            pl_box_dict['mapback_pred_boxes'] = torch.tensor(bbox_optimize.squeeze() * 256 / pl_box_dict['search_resize_factors'])

            pl_box_dict['mapback_pred_boxes'] = clip_box_batch(map_boxes_back_batch(pl_box_dict['search_box_extract'], pl_box_dict['mapback_pred_boxes'],
